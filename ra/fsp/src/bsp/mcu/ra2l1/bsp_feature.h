...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x001F7FFFUL)  // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_CTSU_SUCLK_LV_MAX_MHZ                               (32UL)          // Maximum SUCLK frequency (MHz) in low-voltage operating mode.
#define BSP_FEATURE_CTSU_SUCLK_MAX_MHZ                                  (40UL)          // Maximum SUCLK frequency (MHz) in normal voltage operating mode.
...
#define BSP_FEATURE_LPM_HAS_DCDC_REGULATOR                              (1UL)           // DCDCCTL register is present in SYSC.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK                     (0x020FUL)      // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS_MASK                                   (0x020FUL)      // Mask of available SCI channels.
