...
#define BSP_PERIPHERAL_ACMPLP_PRESENT            (1)
#define BSP_PERIPHERAL_ACMPLP_CHANNEL_MASK       (0x3U)
...
#define BSP_PERIPHERAL_CAN_CHANNEL_MASK          (0x1U)
...
#define BSP_PERIPHERAL_SCI_CHANNEL_MASK          (0x20FU)
...
#define BSP_PERIPHERAL_TRNG_PRESENT              (1)
